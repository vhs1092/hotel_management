...
<div class="panel col-sm-12">
	<h3 class="tab">
		<i class="icon-info"></i> {l s='Reservaciones' mod='hotelreservationsystem'}
		...
		<div class="row">
						...
						<div class="row">	
							...
							<div class="form-group col-sm-12">
								<label for="room_type" class="control-label col-sm-4">
									<span title="" data-toggle="tooltip" class="label-tooltip">{l s='Tipo de habitación' mod='hotelreservationsystem'}</span>
								</label>
								<div class="col-sm-8">
									<select class="form-control" name="room_type" id="room_type">
										{if isset($room_type)}
											<option value='0' {if ($room_type == 0)}selected{/if}>{l s='Todos' mod='hotelreservationsystem'}</option>
			...
			<div class="col-sm-8">
				<div class="row margin-lr-0 box-border calender-main-div">
					<div class="hotel_date col-sm-9">
						<div class="row margin-leftrgt-0">
							<div class="col-sm-12 htl_date_header" style="text-align: center;">
								<div class="col-sm-5">
					...
					<div class="col-sm-3 htl_room_data_cont">
						<div class="row">
							<div class="col-sm-12">
								<div class="row">
									<div class="col-sm-12 htl_room_cat_data">
										<p class="room_cat_header">{l s='Habitaciones totales' mod='hotelreservationsystem'}</p>
							...
							<!--div class="col-sm-6">
								<div class="row">
									<div class="col-sm-12 htl_room_cat_data no_border">
										<p class="room_cat_header">{l s='Parcialmente disponibles' mod='hotelreservationsystem'}</p>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="row">
									<div class="col-sm-12 htl_room_cat_data">
										<p class="room_cat_header">{l s='Habitaciones disponibles' mod='hotelreservationsystem'}</p>
							...
							<!--div class="col-sm-6">
								<div class="row">
									<div class="col-sm-12 htl_room_cat_data no_border">
										<p class="room_cat_header">{l s='Habitaciones reservadas' mod='hotelreservationsystem'}</p>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="row">
									<div class="col-sm-12 htl_room_cat_data">
										<p class="room_cat_header">{l s='Habitaciones no disponibles' mod='hotelreservationsystem'}</p>
						...
						<div class="row">
							<div class="col-sm-12 indi_cont clearfix">
								<div class="color_indicate bg-green"></div>
								<span class="indi_label">{l s='disponibles' mod='hotelreservationsystem'}</span>
							</div>
							...
							<div class="col-sm-12 indi_cont clearfix">
								...
								<span class="indi_label">{l s='no disponibles' mod='hotelreservationsystem'}</span>
							</div>
							<!-- <div class="col-sm-6 indi_cont clearfix">
				...
				<div class="tab-content panel">
					{foreach from=$booking_data['rm_data'] key=book_k item=book_v}
						<div id="room_type_{$book_k}" class="tab-pane {if $book_k == 0}active{/if}">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#avail_room_data_{$book_k}" data-toggle="tab">{l s='Habitaciones disponibles' mod='hotelreservationsystem'}</a></li>
								<!--li><a href="#part_room_data_{$book_k}" data-toggle="tab">{l s='Partially Available' mod='hotelreservationsystem'}</a></li-->
								<li><a href="#book_room_data_{$book_k}" data-toggle="tab">{l s='Habitaciones reservadas' mod='hotelreservationsystem'}</a></li>
								<li><a href="#unavail_room_data_{$book_k}" data-toggle="tab">{l s='Habitaciones no disponibles' mod='hotelreservationsystem'}</a></li>
							</ul>
							<div class="tab-content panel">
								<div id="avail_room_data_{$book_k}" class="tab-pane active">
									<div class="table-responsive">
										<table class="table">
											<thead>
												<tr>
													<th><span class="title_box">{l s='Habitación No.' mod='hotelreservationsystem'}</span></th>
													<th><span class="title_box">{l s='Duración' mod='hotelreservationsystem'}</span></th>
													<th><span class="title_box">{l s='Mensaje' mod='hotelreservationsystem'}</span></th>
													<th style="display: none;"><span class="title_box">{l s='Allotment Type' mod='hotelreservationsystem'}</span></th>
													<th><span class="title_box">{l s='Acción' mod='hotelreservationsystem'}</span></th>
												</tr>
											</thead>
											<tbody>
										...
										<table class="table">
											<thead>
												<tr>
													...
													<th class="text-center" style="display: none;"><span class="title_box">{l s='Allotment Type' mod='hotelreservationsystem'}</span></th>
									...
									<div class="table-responsive">
										<table class="table">
											<thead>
												<tr>
													<th><span class="title_box">{l s='Habitación No.' mod='hotelreservationsystem'}</span></th>
													<th class="text-center"><span class="title_box">{l s='Duración' mod='hotelreservationsystem'}</span></th>
													<th class="text-center"><span class="title_box">{l s='Message' mod='hotelreservationsystem'}</span></th>
													<th class="text-center" style="display: none;"><span class="title_box">{l s='Allotment Type' mod='hotelreservationsystem'}</span></th>
													<th><span class="title_box">{l s='Reasignar' mod='hotelreservationsystem'}</span></th>
												</tr>
											</thead>
											<tbody>
																	...
																	<tr>
																		...
																		<td>
																			<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#mySwappigModal" data-room_num={$booked_v['room_num']} data-date_from={$rm_dtl_v['date_from']} data-date_to={$rm_dtl_v['date_to']} data-id_room={$booked_v['id_room']} data-cust_name="{$rm_dtl_v['alloted_cust_name']}" data-cust_email="{$rm_dtl_v['alloted_cust_email']}" data-avail_rm_realloc={$rm_dtl_v['avail_rooms_to_realloc']|@json_encode} data-avail_rm_swap={$rm_dtl_v['avail_rooms_to_swap']|@json_encode}>
																				{l s='Reasignar habitación' mod='hotelreservationsystem'}
																			</button>
																		</td>
																	{/if}
																	</tr>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class="icon-shopping-cart"></i>&nbsp {l s='Reservación' mod='hotelreservationsystem'}</h4>
			</div>
				...
				<div class="row margin-lr-0">
					<div class="cart_table_container">
						<table class="table table-responsive addtocart-table">
							<thead class="cart-table-thead">
								<tr>
									<th>{l s='Habitación No.' mod='hotelreservationsystem'}</th>
									<th>{l s='Tipo de habitación' mod='hotelreservationsystem'}</th>
									<th>{l s='Duración' mod='hotelreservationsystem'}</th>
									<th>{l s='Total' mod='hotelreservationsystem'}</th>
									<th></th>
								</tr>
							</thead>
					...
					<div class="row cart_amt_div">
						<table class="table table-responsive">
							<tr>
								<th colspan="2">{l s='Total con IVA' mod='hotelreservationsystem'}</th>
			...
			<div class="modal-footer">
				<a href="{$link->getAdminLink('AdminOrders')}&amp;addorder&amp;cart_id={$id_cart|intval}&amp;guest_id={$id_guest|intval}" class="btn btn-primary cart_booking_btn" {if empty($cart_bdata)}disabled="disabled"{/if}>
					{l s='Reservar' mod='hotelreservationsystem'}
				</a>
				<button type="button" class="btn btn-default" data-dismiss="modal">{l s='Cerrar' mod='hotelreservationsystem'}</button>
			</div>
		</div>
	</div>
</div>
			...
			<div role="tabpanel" class="tab-pane active" id="reallocate_room_tab">
				<form method="post" action="">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="realloc_myModalLabel">{l s='Reasignar habitación'}</h4>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<label for="curr_room_num" class="control-label">{l s='Número de habitación actual:' mod='hotelreservationsystem'}</label>
						...
						<div class="form-group">
							<label for="realloc_avail_rooms" class="control-label">{l s='Habitaciones disponibles:' mod='hotelreservationsystem'}</label>
							<div style="width: 195px;">
								<select class="form-control" name="realloc_avail_rooms" id="realloc_avail_rooms">
									<option value="0" selected="selected">{l s='Seleccionar habitación' mod='hotelreservationsystem'}</option>
								</select>
								<p class="error_text" id="realloc_sel_rm_err_p"></p>
							</div>
						</div>
						<div class="form-group">
							<label style="text-decoration:underline;margin-top:5px;" for="message-text" class="col-sm-12 control-label"><i class="icon-info-circle"></i>&nbsp;{l s='Información del cliente' mod='hotelreservationsystem'}</label>
					...
					<div class="modal-footer">
						...
						<input type="submit" id="realloc_allocated_rooms" name="realloc_allocated_rooms" class="btn btn-primary" value="Reasignar">
					</div>
				</form>
			</div>
...
{strip}
	...
	{addJsDefL name=add_to_cart}{l s='Agregar' js=1 mod='hotelreservationsystem'}{/addJsDefL}
	...
	{addJsDefL name=slct_rm_err}{l s='Seleccione una habitación.' js=1 mod='hotelreservationsystem'}{/addJsDefL}
