<div class="panel htl_conf_panel">
	<h3 class="tab"> <i class="icon-cogs"></i>&nbsp;&nbsp; {l s='Configuración del hotel' mod='hotelreservationsystem'}</h3>
	...
	<div class="btn-group setting-link-div col-sm-6 col-xs-12">
		<a type="button" href="{$general_setting_link}" class="setting-link btn btn-default col-sm-10 col-xs-10">
			...
			<span class="setting-title col-sm-10 col-xs-10">{l s='Configuración general' mod='hotelreservationsystem'}</span>
		</a>
		<a tabindex="0" class="btn btn-default col-sm-2 col-xs-2" role="button" data-toggle="popover" data-trigger="focus" title="{l s='Hotel General Settings' mod='hotelreservationsystem'}" data-content="{l s='Configuración general del hotel.' mod='hotelreservationsystem'}" data-placement="bottom">
			<i class="icon-question-circle"></i>
		</a>
	</div>
	<!--div class="btn-group setting-link-div col-sm-3 col-xs-12">
