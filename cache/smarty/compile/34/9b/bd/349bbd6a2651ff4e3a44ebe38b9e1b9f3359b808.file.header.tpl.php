<?php /* Smarty version Smarty-3.1.19, created on 2018-04-27 00:22:57
         compiled from "C:\xampp\htdocs\hotelcommerce\themes\hotel-reservation-theme\header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:207015ae2a5a1362982-24692426%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '349bbd6a2651ff4e3a44ebe38b9e1b9f3359b808' => 
    array (
      0 => 'C:\\xampp\\htdocs\\hotelcommerce\\themes\\hotel-reservation-theme\\header.tpl',
      1 => 1503553336,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '207015ae2a5a1362982-24692426',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ae2a5a146da04_83508195',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ae2a5a146da04_83508195')) {function content_5ae2a5a146da04_83508195($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include 'C:\\xampp\\htdocs\\hotelcommerce\\tools\\smarty\\plugins\\function.implode.php';
?>
<!DOCTYPE HTML>
...
<?php if (isset($_smarty_tpl->tpl_vars['geolocation_country']->value)&&$_smarty_tpl->tpl_vars['geolocation_country']->value) {?> <span class="bold"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['geolocation_country']->value, ENT_QUOTES, 'UTF-8', true);?>
		...
		<div id="page" style="<?php if ($_smarty_tpl->tpl_vars['page_name']->value=='index') {?>height: 100%;<?php }?>">
			<div class="header-container" style="<?php if ($_smarty_tpl->tpl_vars['page_name']->value=='index') {?>height: 100%;<?php }?>">
				<header id="header" style='<?php if ($_smarty_tpl->tpl_vars['page_name']->value=="index") {?>background-image:url("<?php echo $_smarty_tpl->tpl_vars['img_ps_dir']->value;?>
hotel_header_image.jpg"); height: 100%;<?php } else { ?>background-color:#252525;<?php }?>' >
					<div class="banner">
						<div class="container">
							<div class="row">
