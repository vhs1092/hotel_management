...
{if $status == 'ok'}
<p class="alert alert-success">{l s='Tienes'} <b>{$bankwireTime}</b> para realizar tu transferencia, de lo contrario tu reservación será cancelada.</p><br /><br />
